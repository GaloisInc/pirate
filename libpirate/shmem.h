...
ssize_t shmem_buffer_read(pirate_shmem_param_t *param, shmem_ctx *ctx, void *buf, size_t count);
ssize_t shmem_buffer_write(pirate_shmem_param_t *param, shmem_ctx *ctx, const void *buf, size_t count);
