...
ssize_t shmem_buffer_read(const pirate_shmem_param_t *param, gaps_tag_t *tag, shmem_ctx *ctx, void *buf, size_t count);
ssize_t shmem_buffer_write(const pirate_shmem_param_t *param, gaps_tag_t tag, shmem_ctx *ctx, const void *buf, size_t count);
