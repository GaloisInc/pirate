...
static int pirate_tcp_socket_parse_param(char *str, void *_param) {
...
static int pirate_tcp_socket_get_channel_description(const void *_param, char *desc, int len) {
...
static int pirate_tcp_socket_open(void *_param, void *_ctx) {
    pirate_tcp_socket_param_t *param = (pirate_tcp_socket_param_t *)_param;
...
static int pirate_tcp_socket_close(void *_ctx) {
    tcp_socket_ctx *ctx = (tcp_socket_ctx *)_ctx;
    int rv = -1;
...
static ssize_t pirate_tcp_socket_read(const void *_param, void *_ctx, void *buf, size_t count) {
    const pirate_tcp_socket_param_t *param = (const pirate_tcp_socket_param_t *)_param;
    return pirate_stream_read((common_ctx*) _ctx, param->min_tx, buf, count);
}

static ssize_t pirate_tcp_socket_write_mtu(const void *_param) {
    const pirate_tcp_socket_param_t *param = (const pirate_tcp_socket_param_t *)_param;
...
static ssize_t pirate_tcp_socket_write(const void *_param, void *_ctx, const void *buf, size_t count) {
    const pirate_tcp_socket_param_t *param = (const pirate_tcp_socket_param_t *)_param;
...
void pirate_tcp_socket_init(pirate_channel_funcs_t *funcs) {
    funcs->parse_param             = pirate_tcp_socket_parse_param;
    funcs->get_channel_description = pirate_tcp_socket_get_channel_description;
    funcs->open                    = pirate_tcp_socket_open;
    funcs->close                   = pirate_tcp_socket_close;
    funcs->read                    = pirate_tcp_socket_read;
    funcs->write                   = pirate_tcp_socket_write;
    funcs->write_mtu               = pirate_tcp_socket_write_mtu;
}
