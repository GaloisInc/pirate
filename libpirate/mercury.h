...
ssize_t pirate_mercury_read(const pirate_mercury_param_t *param, gaps_tag_t *tag, mercury_ctx *ctx, void *buf, size_t count);
ssize_t pirate_mercury_write(const pirate_mercury_param_t *param, gaps_tag_t tag, mercury_ctx *ctx, const void *buf, size_t count);
