...
ssize_t pirate_ge_eth_read(const pirate_ge_eth_param_t *param, gaps_tag_t *tag, ge_eth_ctx *ctx, void *buf, size_t count);
ssize_t pirate_ge_eth_write(const pirate_ge_eth_param_t *param, gaps_tag_t tag, ge_eth_ctx *ctx, const void *buf, size_t count);
