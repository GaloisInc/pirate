...
- When attempting to read from an empty channel and no process has the channel open for writing, read() shall return 0 to indicate end-of-file. See `read <https://pubs.opengroup.org/onlinepubs/009695399/functions/read.html>`_
