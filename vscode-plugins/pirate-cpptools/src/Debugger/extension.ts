...
import { QuickPickConfigurationProvider, ConfigurationAssetProviderFactory, CppVsDbgConfigurationProvider, CppDbgConfigurationProvider, ConfigurationSnippetProvider, IConfigurationAssetProvider, PirateCppDbgConfigurationProvider } from './configurationProvider';
...
export function initialize(context: vscode.ExtensionContext): void {
    ...
    const pirateProvider: PirateCppDbgConfigurationProvider = new PirateCppDbgConfigurationProvider(configurationProvider);
    disposables.push(vscode.debug.registerDebugConfigurationProvider('cppdbg', pirateProvider));
