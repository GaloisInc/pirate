...
int __start_pirate_res_boolean;
int __stop_pirate_res_boolean;
int __start_pirate_res_integer;
int __stop_pirate_res_integer;
int __start_pirate_res_file;
int __stop_pirate_res_file;
int __start_pirate_res_pirate_channel;
int __stop_pirate_res_pirate_channel;
