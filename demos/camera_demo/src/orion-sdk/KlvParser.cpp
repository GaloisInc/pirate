...
KlvTagInfo_t TagInfo[KLV_UAS_NUM_ELEMENTS] = {
    /*KLV_UAS_NULL = 0, */                  { KLV_TYPE_OTHER, 0, 0 },
    /*KLV_UAS_CHECKSUM = 1, */              { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_TIME_STAMP = 2, */            { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_MISSION_ID = 3, */            { KLV_TYPE_STRING, 0, 0 },
    /*KLV_UAS_TAIL_NUMBER = 4, */           { KLV_TYPE_STRING, 0, 0 },
    ...
    /*KLV_UAS_PLATFORM_TAS = 8, */          { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_PLATFORM_IAS = 9, */          { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_PLATFORM_ID = 10 */           { KLV_TYPE_STRING, 0, 0 },
    /*KLV_UAS_SENSOR_ID = 11 */             { KLV_TYPE_STRING, 0, 0 },
    /*KLV_UAS_COORD_SYSTEM = 12 */          { KLV_TYPE_STRING, 0, 0 },
    ...
    /*KLV_UAS_ICING = 34 */                 { KLV_TYPE_UINT, 0, 0 },
    ...
    /*KLV_UAS_OAT = 39 */                   { KLV_TYPE_INT, 0, 0 },
    ...
    /*KLV_UAS_TRACK_WIDTH = 43 */           { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_TRACK_HEIGHT = 44 */          { KLV_TYPE_UINT, 0, 0 },
    ...
    /*KLV_UAS_GENERIC_FLAG = 47 */          { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_SECURITY = 48 */              { KLV_TYPE_OTHER, 0, 0 },
    ...
    /*KLV_UAS_GROUND_SPEED = 56 */          { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_GROUND_RANGE = 57 */          { KLV_TYPE_DOUBLE, 0, 5000000 },
    /*KLV_UAS_FUEL_REMAINING = 58 */        { KLV_TYPE_DOUBLE, 0, 10000 },
    /*KLV_UAS_CALLSIGN = 59 */              { KLV_TYPE_STRING, 0, 0 },
    /*KLV_UAS_WEAPON_LOAD = 60 */           { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_WEAPON_FIRED = 61 */          { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_LASER_PRF_CODE = 62 */        { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_FOV_NAME = 63 */              { KLV_TYPE_STRING, 0, 0 },
    /*KLV_UAS_VERSION = 65 */               { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_MAGNETIC_HEADING = 64 */      { KLV_TYPE_DOUBLE, radians(0), radians(360) },
    /*KLV_UAS_TARGET_COVARIANCE = 66 */     { KLV_TYPE_OTHER, 0, 0 },
    ...
    /*KLV_UAS_ALT_PLATFORM_NAME = 70 */     { KLV_TYPE_STRING, 0, 0 },
    /*KLV_UAS_ALT_PLATFORM_HEADING = 71 */  { KLV_TYPE_DOUBLE, radians(0), radians(360) },
    /*KLV_UAS_EVENT_START_TIME = 72 */      { KLV_TYPE_UINT, 0, 0 },
    /*KLV_UAS_RVT_LOCAL_SET = 73 */         { KLV_TYPE_OTHER, 0, 0 },
    /*KLV_UAS_VMTI = 74 */                  { KLV_TYPE_OTHER, 0, 0 },
    /*KLV_UAS_SENSOR_HAE = 75 */            { KLV_TYPE_DOUBLE, -900, 19000 },
    /*KLV_UAS_ALT_PLATFORM_HAE = 76 */      { KLV_TYPE_DOUBLE, -900, 19000 },
    /*KLV_UAS_OPERATIONAL_MODE = 77 */      { KLV_TYPE_UINT, 0, 0 },
    ...
    /*KLV_UAS_IMAGE_HORIZON = 81 */         { KLV_TYPE_OTHER, 0, 0 },
    ...
    /*KLV_UAS_CORE_ID = 94 */               { KLV_TYPE_STRING, 0, 0 },
};
